# Config for finetuning Darknet53 to 448x448 model on simple-aug ImageNet2012 dataset for image classification as the backbone for YOLOv3
import time
...
max_iters = 200200  # 20 epochs, finish in 35 hr on my machine
