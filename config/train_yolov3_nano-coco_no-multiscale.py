# Config for training YOLOv3 model on single-scale nano COCO dataset for object detection debug
# Train on nano COCO 2017 train, and evaluate on nano COCO 2017 val
import time
