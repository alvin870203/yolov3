# Config for training YOLOv3 model on blank no-aug nano COCO dataset for object detection debug
# Train on blank nano COCO 2017 train, and evaluate on blank nano COCO 2017 val
import time
...
# nano coco train set has 5 imgs, so 1 epoch ~= 3 iters
...
# Eval related
# coco val set has 5 imgs, so 1 epoch ~= 3 iters
...
out_dir = f'out/yolov3_nano-coco/{timestamp}'
wandb_log = True
wandb_project = 'nano-coco'
