...
# Data related
dataset_name = 'coco'
img_h = 640  # TODO: increase to 1280
img_w = 640  # TODO: increase to 1280
n_class = 80

# Transform related  # TODO: try stronger aug
aug_type = 'default'
letterbox = True
...
multiscale_h = (640,)  # TODO: enable multisclae
multiscale_w = (640,)  # TODO: enable multisclae
...
# Loss related
match_by = 'wh_ratio'  # TODO: try 'wh_iou' w/ 0.2 match_thresh
match_thresh = 4.0  # TODO: try 'wh_iou' w/ 0.2 match_thresh
...
balance = (4.0, 1.0, 0.4)
lambda_box = 0.05
lambda_obj = 1.0 * ((640*640)/(640*640))  # scaled from area 640*640 to 640*640TODO
lambda_class = 0.5 * (80/80)  # scaled from 80 classes to 80TODO classes

# Train related
# the number of examples per iter:
# 32TODO batch_size * 1TODO grad_accum = 32 imgs/iter
# coco train set has 118,287 imgs, so 1 epoch ~= 3,697 iters
gradient_accumulation_steps = 1
batch_size = 32  # filled up the gpu memory on my machine
max_iters = 1109100  # 300 epochs, finish in TODO hr on my machine

# Optimizer related  # from ultralytics/yolov3: hyp.scratch-low.yaml   # TODO: try optim for stronger aug
optimizer_type = 'sgd'  # TODO: try 'adam' w/ 1e-4 lr
learning_rate = 1e-2
beta1 = 0.937
beta2 = 0.999
weight_decay = 5e-4
...
# Eval related
# coco val set has 5,000 imgs, so 1 epoch ~= 157TODO iters
eval_interval = 11091  # keep frequent if we'll overfit  # TODO: <= warmup_iters, >= 1 epoch
eval_iters = 157  # use entire val set to get good estimate  # TODO: decrease to speedup
score_thresh = 0.001
