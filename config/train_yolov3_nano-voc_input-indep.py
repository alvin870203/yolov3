# Config for training YOLOv3 model on blank no-aug nano VOC dataset for object detection debug
# Train on blank nano VOC 2007 trainval and 2012 trainval, and evaluate on nano VOC 2007 test
import time
