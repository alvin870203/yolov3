...
lambda_obj = 0.51728 * ((416*416)/(640*640))  # from ultralytics/yolov3: hyp.VOC.yaml, scaled from area 640*640 to 416*416
...
max_iters = 77700  # 300 epochs, finish in 9 hr on my machine
