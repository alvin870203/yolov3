# Config for training YOLOv3 model on blank no-aug Pascal VOC 2007&2012 VOC dataset for object detection
# as the lower-bound training/validation accuracy (input-independent) baseline
