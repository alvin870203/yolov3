# Config for training Darknet53 model on blank no-aug ImageNet2012 dataset for image classification
# as the lower-bound training/validation accuracy (input-independent) baseline of the backbone for YOLOv3
import time
